...
namespace RoverSensors.Views
{
    ...
    public sealed partial class sensor_data_small : Page
    {
        ...
        public void PositionPopup()
        {
            ...
            DataPopupGrid.Height = (Window.Current.Bounds.Height - 20) * 3 / 5;

            DataPopupBorder.Width = DataGrid.ActualWidth;
            DataPopupBorder.Height = (Window.Current.Bounds.Height - 20) *3 / 5;

            DataPopup.Width = DataGrid.ActualWidth;
            DataPopup.Height = (Window.Current.Bounds.Height - 20) *3 / 5;
        }
