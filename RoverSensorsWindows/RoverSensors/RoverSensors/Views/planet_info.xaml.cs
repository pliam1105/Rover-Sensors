...
namespace RoverSensors.Views
{
    ...
    /// </summary>
    public sealed partial class planet_info : Page
    {
        ...
        public void PositionPopup()
        {
            ...
            InfoPopupGrid.Height = Window.Current.Bounds.Height - 20;

            InfoPopupBorder.Width = InfoGrid.ActualWidth;
            InfoPopupBorder.Height = Window.Current.Bounds.Height - 20;

            InfoPopup.Width = InfoGrid.ActualWidth;
            InfoPopup.Height = Window.Current.Bounds.Height - 20;
        }
